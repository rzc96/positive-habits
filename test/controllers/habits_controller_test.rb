...
class HabitsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create habit" do
    assert_difference('Habit.count') do
      post habits_url, params: { habit: { date: @habit.date, duration: @habit.duration, title: @habit.title } }
    end
  ...
  test "should update habit" do
    patch habit_url(@habit), params: { habit: { date: @habit.date, duration: @habit.duration, title: @habit.title } }
